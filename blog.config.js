...
const BLOG = {
  AUTHOR: 'CAIJI', // 作者
  BIO: '一个普通的干饭人🍚', // 作者简介
  LINK: 'https://caijiblog.vercel.app/', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '3508432c7e804670bed2b7dfb7b76acf', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: '2056608018@qq.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/yikongcheng',
  CONTACT_TELEGRAM: '',
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'yikongcheng/NotionNext', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'CAIJI BLOG', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '这是一个个人博客站点', // 站点描述，被notion中的页面描述覆盖
